...
const EyeCareSettings = () => {
  ...
  useEffect(() => {
    const storedGoal = localStorage.getItem("eyeBreakGoal");
    const storedSchedule = localStorage.getItem("eyeBreakSchedule");
    ...
    if (storedSchedule) {
      try {
        ...
        console.error(
          "Failed to load eye break settings:",
          error
        );
      }
    }
  ...
  console.log("SAVING EYE BREAK SETTINGS");
  ...
  const resetToday = () => {
    ...
    window.dispatchEvent(
      new Event("eyeBreakTodayReset")
    );

    setResetMessage(
      "Today's eye break progress has been reset."
    );
    ...
    <div className="eye-care-settings">
      ...
      <div className="eye-care-settings-header">
        ...
        <div>
          <h2>Eye Care</h2>
          <p>
            Customize your daily eye break goal and reminder schedule.
          </p>
        </div>
      </div>
      ...
      <div className="eye-care-setting-card">
        ...
        <div className="setting-header">
          ...
          <div>
            ...
            <p>
              Choose how many eye breaks you want to complete each day.
            </p>
          </div>
      ...
      <div className="eye-care-setting-card">
        ...
        <div className="setting-header">
          ...
          <div>
            ...
            <p>
              Set the time for each of your daily eye breaks.
            </p>
          </div>
      ...
      <div className="reset-card">
        ...
        <div className="reset-header">
          ...
          <div>
            ...
            <p>
              Restart today's eye-break progress.
      ...
      <style>{`
        ...
        .eye-care-settings-header h2 {
          margin: 0 0 4px;
          font-size: 28px;
          font-weight: 700;
        }

        .eye-care-settings-header p {
          margin: 0;
          color: #6b7280;
          font-size: 14px;
        }

        .eye-care-setting-card {
          background: #ffffff;
          border: 3px solid #000;
          border-radius: 22px;
          padding: 22px;
